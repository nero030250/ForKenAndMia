...
public class MissionManager : UISingleton <MissionManager> {
	...
	protected override void Awake () {
		...
		MissionDic[1].SetKey (KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Ti, KeyType.TiD);
		...
		MissionDic[2].SetKey(KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Fa
			, KeyType.Fa, KeyType.Fa, KeyType.Fa, KeyType.Ti, KeyType.Ti);
		...
		MissionDic [3].SetKey (KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Do
			...
			, KeyType.So, KeyType.So, KeyType.So, KeyType.Ti, KeyType.Ti);
		...
		MissionDic [4].SetOrder (KeyType.Do, KeyType.Fa, KeyType.Ti, KeyType.Ti, KeyType.La);
		MissionDic [4].SetKey (KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Do
			...
			, KeyType.So, KeyType.So, KeyType.La, KeyType.Ti, KeyType.Ti);
		...
		MissionDic [5].SetKey (KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Do, KeyType.Do
			...
			, KeyType.Ti, KeyType.Ti, KeyType.DoU, KeyType.DoU, KeyType.DoU);
